...
class TrainDataset(Dataset):
    ...
    def __init__(self, image_dir, label_dir=None, crop_size=64, transforms=None, num_samples=4, train=True):
    ...
    def __getitem__(self, idx):
        ...
        img_transforms = Compose([AddChannel(), Flip(), Rotate90(), RandGaussianNoise(prob=0.8), RandGaussianSmooth()])
        label_transforms = Compose([AddChannel(), Flip(), Rotate90()])
    ...
    def get_dataloader(dataset, batch_size, shuffle=False, num_workers=0):
        return DataLoader(dataset, batch_size, shuffle, num_workers=num_workers, collate_fn=TrainDataset.collate_fn)
...
class TestDataset(Dataset):
    ...
    def get_dataloader(dataset, batch_size, num_workers=0):
        return DataLoader(dataset, batch_size, num_workers=num_workers, collate_fn=TestDataset._collate_fn)